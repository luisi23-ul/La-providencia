...
// NOTA: Ya no abrimos ningún contenedor aquí, entramos directo a la lógica de la tarjeta
if(isset($p) && $p): 
?>
...
<?php else: ?>
    <article class="card-formulario" style="text-align: center; max-width: 500px; margin: 0 auto; padding: 40px;">
