...
<section class="card-pagos">
    ...
    <?php if (!empty($ventas)): ?>
        ...
        <tr>
            <td><?php echo htmlspecialchars($venta->nombre_cliente); ?></td> <td><?php echo htmlspecialchars($venta->fecha); ?></td>
    ...
    <?php else: ?>
        <tr>
            <td colspan="7" style="text-align: center; padding: 20px; color: #666;">No hay pedidos listos para retiro.</td>
        </tr>
    <?php endif; ?>
</tbody>
        </table>
